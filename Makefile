...
terraform_build:
	...
	@cd provider && go build -o terraform-provider-sdk$$(go env GOEXE)
	...
	@mv ./provider/terraform-provider-sdk$$(go env GOEXE) ./provider/config/terraform.d/plugins/terraform.kutac.cz/superdupercloud/sdk/0.1.0/$$(go env GOHOSTOS)_$$(go env GOHOSTARCH)/
